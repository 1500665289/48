...
local tbMagic = tbTable:GetMagic("SQXianKui");--创建一个新的神通class
...
function tbMagic:TargetCheck(key, t)	
	if t.ThingType == CS.XiaWorld.g_emThingType.Npc and t.Race.RaceType ~= CS.XiaWorld.g_emNpcRaceType.Animal then
		return true;
	else
		return false;
	end
